    ...
    return (
        <div className="max-w-[1170px] mx-auto py-16">
            ...
            <div className='flex flex-col md:flex-row md:items-center mt-16'>
                <div className='bg-[#A6E2E2] h-full min-h-[380px]  p-5 place-content-center space-y-5'>
                ...
                <div className='min-w-[calc(60%)]'>
                    <Image src={'/whatwedo/Right.png'} width={2000} height={500} className='max-w-[800px] w-full aspect-auto' alt='right image'/>
                </div>
            </div>
