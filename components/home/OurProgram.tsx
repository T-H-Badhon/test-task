    ...
    <div className="max-w-[1170px] mx-auto px-5">
      ...
      <div className="w-full grid md:grid-cols-3 mt-14 space-y-5 md:space-y-0">
        <div className="flex items-center gap-2 w-full border-b-[4px] px-2 pb-2 border-[#29BDBF]">
          <div>
            <Image
              src={"/ourprogram/self-development.png"}
              width={50}
              height={50}
        ...
        <div className="flex items-center gap-2 w-full border-b-[4px] px-2 pb-2 border-[#F2F2F2]">
          <div>
            <Image
              src={"/ourprogram/certificate.png"}
              width={50}
              height={50}
              className="w-10 aspect-square"
              alt="icon"
...
const ProgramCard = ({ image, title }: { image: string; title: string }) => {
  return (
    <div className="bg-white rounded-lg p-4 card-shadow-full">
      <div>
        <Image
          src={image}
          width={500}
          height={500}
          className="w-[380px] aspect-auto p-1"
          alt="image"
        />
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            <button className="py-2 px-4 bg-[#F15B2D] rounded-lg text-white">
              Enroll Now
            </button>
          </div>
        </div>
