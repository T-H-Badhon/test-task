...
const NavContent = () => {
    return (
        <div className='flex items-center justify-between  max-w-[1170px] mx-auto h-[102px]'>

            <div>
                <Image src={"/logos/Logo-Main.png"} width={200} height={100} alt='logo' className="w-[173px] aspect-auto"/>
            </div>

            <div className='uppercase flex items-center gap-2 text-[14px] font-semibold'>
